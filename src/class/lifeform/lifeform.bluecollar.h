...
;external parameters
.enum 0 export
  lifeform.bluecollar.parameter.pos.x db
  lifeform.bluecollar.parameter.pos.y db
  lifeform.bluecollar.parameter.size.x db
  lifeform.bluecollar.parameter.size.y db
  lifeform.bluecollar.parameter.berzerk.yield db
.ende
